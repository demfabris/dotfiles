...
let airline#extensions#tmuxline#snapshot_file = "~/.config/nvim/.tmux-status.conf"
...
let g:tmuxline_preset = {
      ...
      \'win'  : ['#I', '#W'],
      \'cwin' : ['#I', '#W'],
      \'y'    : "#(free -m | awk 'FNR==2 {print $3}') MiB",
      \'z'    : "#(free -m | awk 'FNR==2 {print $2}') MiB  "}
